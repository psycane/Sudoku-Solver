...
// Created: 2/8/2012 9:51:24 PM

function WebTrends() {
    var that = this;
    // begin: user modifiable
    this.dcsid = "dcsrefwbsblq1tcdick7hwcm6_7v5d";
    this.domain = "datacoll.spie.org";
    this.timezone = -5;
    this.fpcdom = ".spiedigitallibrary.org";
    this.onsitedoms = (function () { return (window.RegExp ? new RegExp(".*spiedigitallibrary\.org", "i") : ""); })();
    this.downloadtypes = "xls,doc,pdf,txt,csv,zip,docx,xlsx,mov,tiff,jpg,jpeg,mpeg";
